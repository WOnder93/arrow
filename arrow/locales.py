...
# for Russian, Ukrainian, Belarusian, Serbian, Croatian
# see https://www.gnu.org/software/gettext/manual/html_node/Plural-forms.html
class RussianLikeBaseLocale(Locale):
...
class PolishLocale(Locale):
    ...
    # Polish has special kind of plural forms,
    # see https://www.gnu.org/software/gettext/manual/html_node/Plural-forms.html
    def _format_timeframe(self, timeframe, delta):
    ...
    timeframes = {
        ...
        'minute': 'minutę',
        'minutes': ['{0} minutę', '{0} minuty', '{0} minut'],
        'hour': 'godzina',
...
class RussianLocale(RussianLikeBaseLocale):
...
class UkrainianLocale(RussianLikeBaseLocale):
...
# see https://www.gnu.org/software/gettext/manual/html_node/Plural-forms.html
class CzechAndSlovakBaseLocale(Locale):
...
class SlovakLocale(CzechAndSlovakBaseLocale):
    ...
    timeframes = {
        'now': 'teraz',
        'seconds': 'niekoľko sekúnd',
        'minute': 'minúta',
        'minutes': ['{0} minúta', '{0} minúty', '{0} minút'],
        'hour': 'hodina',
        'hours': ['{0} hodina', '{0} hodiny', '{0} hodín'],
        'day': 'deň',
        'days': ['{0} deň', '{0} dni', '{0} dní'],
        'month': 'miesiac',
        'months': ['{0} mesiac', '{0} mesiace', '{0} mesiacov'],
        'year': 'rok',
        'years': ['{0} rok', '{0} roky', '{0} rokov'],
    }
 
    month_names = ['', 'január', 'február', 'marec', 'apríl', 'máj',
...
class CzechLocale(CzechAndSlovakBaseLocale):
    ...
    timeframes = {
        'now': 'teď',
        'seconds': 'nekolik vteřin',
        'minute': 'minuta',
        'minutes': ['{0} minuta', '{0} minuty', '{0} minut'],
        'hour': 'hodina',
        'hours': ['{0} hodina', '{0} hodiny', '{0} hodin'],
        'day': 'den',
        'days': ['{0} den', '{0} dny', '{0} dní'],
        'month': 'měsíc',
        'months': ['{0} měsíc', '{0} měsíce', '{0} měsíců'],
        'year': 'rok',
        'years': ['{0} rok', '{0} léta', '{0} let'],
    }
 
    month_names = ['', 'leden', 'únor', 'březen', 'duben', 'květen',
